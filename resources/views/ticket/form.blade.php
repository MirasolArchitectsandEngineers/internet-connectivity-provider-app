<form wire:submit="create">
  <div class="grid grid-cols-2 gap-6">
    <div class="col-span-2">
      <x-label for="router_id"
        value="Router" />
      <x-select id="router_id"
        wire:model="input.router_id"
        :options="$routers"
        option-value="id"
        option-text="name"
    ...
    <div class="col-span-2">
      ...
      <x-input type="text"
        id="count"
        wire:model="input.count"
        class="block w-full mt-1" />
      <x-input-error for="count"
        class="mt-2" />
    </div>
    <div class="col-span-1">
      <x-label for="ticket_template_id"
        value="Template" />
      <x-select id="ticket_template_id"
        wire:model.live="input.ticket_template_id"
